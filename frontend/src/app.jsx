        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              />
              {errors.initial_wallet && <p className="text-[10px] text-red-500 mt-1 uppercase font-bold">{errors.initial_wallet.message}</p>}
            </div>

            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Final Wallet</label>
              <input
                {...register("final_wallet", { required: "Required" })}
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                type="button"
                onClick={() => setValue("use_url", !isUrlMode)} // Cambia el valor interno de React Hook Form
            ...
            {isUrlMode ? (
              <div className="animate-in fade-in duration-300">
                <input
                  {...register("csv_url", { required: isUrlMode })}
                  type="url"
              ...
              <input
                type="file"
                {...register("csv_file", { required: !isUrlMode })}
